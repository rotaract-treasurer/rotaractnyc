          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {articles.map((article) => (
              ...
              >
                ...
                <div className="relative h-48 bg-gradient-to-br from-cranberry-100 to-cranberry-50 dark:from-cranberry-900/20 dark:to-cranberry-950/30 flex items-center justify-center overflow-hidden">
                  {article.coverImage ? (
                    <Image src={article.coverImage} alt={article.title} fill className="object-cover group-hover:scale-105 transition-transform duration-300" sizes="(max-width: 768px) 100vw, (max-width: 1024px) 50vw, 33vw" />
                  ) : (
                    <svg aria-hidden="true" className="w-12 h-12 text-cranberry-300 dark:text-cranberry-700" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className="p-6">
                  <div className="flex items-center gap-3 mb-3">
                    ...
                    <span className="text-xs text-gray-500 dark:text-gray-400">{article.publishedAt ? formatDate(article.publishedAt) : ''}</span>
                  </div>
